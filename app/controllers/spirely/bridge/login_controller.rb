module Spirely
  module Bridge
    ...
    # link" requests.
    #
    # No design investment here (bare HTML) — this engine has no frontend of
    # its own. A host app with a real frontend (e.g. spirely-church) shadows
    # this with its own richer bridge/login controller, declared before it
    # mounts this engine — see Spirely::Engine's own routing comment.
